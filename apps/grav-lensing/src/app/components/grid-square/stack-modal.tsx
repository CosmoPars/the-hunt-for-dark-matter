  ...
  if(open === true && scanResult){   
    if(scanResult.hasDarkMatter){
      ...
      <>
        ...
        <DarkMatterDiv><DotDiv></DotDiv></DarkMatterDiv>
        <StackFooter>
            <DarkMatterText>You've found a clump of Dark Matter!</DarkMatterText>
            <PrimaryButton onClick ={() => {ClickSound.play(); onClose();}}>NEXT</PrimaryButton>
        </StackFooter>
        </div>
      </>
      )
